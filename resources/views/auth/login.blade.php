...
@section('content')
    <div class="App">
        ...
        <section class="authentication-section">
            <section class="authentication-section">
                <div class="d-flex flex-direction-row justify-around login-section">
                    <div class="image-container"><img src="login.png" width="650px" height="550px" alt="loginimage"></div>
                    <div class="login-container">
                        <div class="d-flex justify-center login-header font-oswald">Welcome back</div>
                        @if ($errors->any())
                    ...
                    @endif
                        <form class="d-flex flex-direction-column w-100" action="{{ route('login') }}" method="POST">
                            @csrf
                            <div class="d-flex flex-direction-column"><input type="email" id="email" name="email"
                                    placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" size="30"
                                    required="" value="">
                                <input type="password" id="password" name="password" placeholder="Password" minlength="8"
                                    required="" value="">
                            </div>
                            <div class="d-flex flex-direction-column align-items-center"><button class="btn login-btn"
                                    type="submit">Sign in</button><br>
                                <div id="invalid-cred" class="d-none">Invalid Email address or Password!</div><br>
                                <div> <a class="link-style" href="">Forgot Password ?</a> <span
                                        style="cursor: pointer; font-weight: 500; color: var(--primary-bg-1);"></span></div>
                                <p>Don't have an account yet? <a class="link-style" href="/register">Register</a> here
                                </p>
                            </div>
                        </form>
                    </div>
