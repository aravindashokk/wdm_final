            ...
            <section class="authentication-section">
                <div class="d-flex flex-direction-row justify-around registration-section">
                    <div class="registration-container">
                        ...
                        <div class="d-flex justify-center registration-header font-oswald"><small>School
                                Account</small></div>
                        @if ($errors->any())
                        ...
                        <form class="d-flex flex-direction-column w-100" id="registration-form" method="POST"
                            action="{{ route('storeschoolaccount') }}">
                            @csrf
                            <div class="d-flex flex-direction-column">
                                <input type="text" id="email" name="admin_full_name" placeholder="Admin full name" required=""
                                ...
                                <input type="number" id="email" name="phone_number" placeholder="Your Phone Number"
                                    ...
                                    <input type="text" id="email" name="school_name" placeholder="School Name"
                                    required="" value="{{ old('school_name') }}">

                                <div class="px-5">
                                    <textarea name="address_address" id="" cols="30" rows="5" class="form-control my-3"
                                        placeholder="School location address"></textarea>
                                </div>
                            ...
                            <div class="d-flex flex-direction-column align-items-center"><button class="btn register-btn"
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('businessaccount') }}" class="link-style"> Business
                                        Account</a>
                                </div>
                            </div>
                        </form>
