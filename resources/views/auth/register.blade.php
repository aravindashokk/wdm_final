            ...
            <section class="authentication-section">
                <div class="d-flex flex-direction-row justify-around registration-section">
                    <div class="registration-container">
                        ...
                        <div class="d-flex justify-center registration-header font-oswald"><small>Create an Student
                                Account</small></div>
                        @if ($errors->any())
                        ...
                        <form class="d-flex flex-direction-column w-100" id="registration-form" method="POST"
                            action="{{ route('createstudentaccount') }}">
                            @csrf
                            <div class="d-flex flex-direction-column">
                                <div class="d-flex flex-direction-row justify-around">
                                    <input type="text" class="name-input" id="fname" name="first_name"
                                        placeholder="First Name" maxlength="60" required=""
                                        value="{{ old('first_name') }}">
                                    <input type="text" class="name-input" id="lname" name="last_name"
                                        placeholder="Last Name" maxlength="60" required=""
                                        value="{{ old('last_name') }}">
                                </div>
                                ...
                                <div class="d-flex flex-direction-row justify-center align-items-center px-5">
                                    @php
                                    $schools = App\Models\School::all();
                                @endphp
                                    <select
                                        name="school_name" id="user_type" class="form-control" required="">
                                ...
                                <textarea name="address_address" id="" cols="30" rows="5" class="form-control my-3" placeholder="Your home address"></textarea>
                            </div>
                            ...
                            <div class="d-flex flex-direction-column align-items-center"><button class="btn register-btn"
                                ...
                                <div class="col-12">
                                    <a href="{{ route('schoolaccount') }}" class="link-style">Create School Account</a>
                                    <a href="{{ route('businessaccount') }}" class="link-style">Create Business Account</a>
                                </div>
                            </div>
                        </form>
                    </div>
