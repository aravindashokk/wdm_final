...
<div class="card">
    ...
    <div class="card-body pt-1">
        <!-- form -->
        <form class="validate-form" method="POST" action="{{ route('businessowner.updatepassword') }}">
            @csrf
            <div class="row">
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <!-- form -->
        <form class="validate-form" method="POST" action="{{ route('businessowner.saveaccountemail') }}">
            @csrf
            <div class="row">
                <div class="col-12 col-sm-6 mb-1">
