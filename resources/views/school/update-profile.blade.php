...
<div class="card">
    ...
    <div class="card-body pt-1">
        <!-- form -->
        <form class="validate-form" method="POST" action="{{ route('schooladmin.updatepassword') }}">
            @csrf
            <div class="row">
...
<div class="card">
    ...
    <div class="card-body pt-1">
        <!-- form -->
        <form class="validate-form" method="POST" action="{{ route('schooladmin.saveaccountemail') }}">
            @csrf
            <div class="row">
                <div class="col-12 col-sm-6 mb-1">
